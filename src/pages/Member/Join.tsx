...
const Join = () => {
    ...
    const sendEmail = async () => {
        try{
            const response = await axios.post('/email', { email, emailType: "sign-up", socialType: "SoundOfFlower" });
    ...
    const verifyNickname = async () => {
        try{
            const response = await axios.post('/register/authentication/nickname', {nickName});
